...
impl<E: fmt::Display> fmt::Display for RecycleError<E> {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            Self::Message(msg) => write!(f, "Error occurred while cleanup postgresql connection (postgresql_cleanup_error): {}", msg),
            Self::StaticMessage(msg) => {
                write!(f, "Error occurred while cleanup postgresql connection (postgresql_cleanup_error): {}", msg)
            }
            Self::Backend(e) => write!(f, "Error occurred while cleanup postgresql connection (postgresql_cleanup_error): {}", e),
        }
    }
}
    ...
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            Self::Timeout(tt) => match tt {
                ...
                TimeoutType::Create => write!(f, "Timeout occurred while creating a new connection to postgresql (postgresql_login_timeout)"),
                TimeoutType::Recycle => write!(f, "Timeout occurred while cleanup connection to postgresql (postgresql_cleanup_timeout)"),
            },
            Self::Backend(e) => write!(f, "Error occurred while creating a new connection to postgresql (postgresql_login_error): {}", e),
